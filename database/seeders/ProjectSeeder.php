...
class ProjectSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($projects as $projectData) {
            ...
            // Add specific images for Arabic projects
            if ($project->title_ar === 'كفالة 100 يتيم') {
                $project->addMediaFromUrl('https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=1200')
                    ->toMediaCollection('images');
            } elseif ($project->title_ar === 'بناء مدرسة في اليمن') {
                $project->addMediaFromUrl('https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=800')
                    ->toMediaCollection('images');
            } elseif ($project->title_ar === 'مستشفى ميداني في غزة') {
                $project->addMediaFromUrl('https://images.unsplash.com/photo-1516549655169-df83a0774514?q=80&w=2070')
                    ->toMediaCollection('images');
            }
        }
    }
